...
class OnTheAirComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TvBloc, TvState>(
        buildWhen: (previous, current) =>previous.onTheAirState != current.onTheAirState,
            ...
            case RequestState.loaded:
              return FadeIn( duration: const Duration(milliseconds: 500),
                child: CarouselSlider(
                  ...
                  items: state.onTheAirTvs
                      .map(
                        (item) => GestureDetector(
                          key: const Key('openTvMinimalDetail'),
                          onTap: () {
                            //TODO : on tap function navigator
                          },
                          child: Stack(
                            children: [
                              ShaderMask(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      Text(
                                        AppStrings.onTheAir.toUpperCase(),
